...
final class PRCommitsViewStateTests: XCTestCase {
    
    var presenter: PRCommitsPresenterProtocol!
    var interactor: MockPRCommitsInteractor!
    
    override func setUp() {
        interactor = MockPRCommitsInteractor()
